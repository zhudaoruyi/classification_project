...
def classify(predictions):
    ...
    def score_tune(pre, k):
        pre[0][k[0]] = 1
        pre[0][0:k[0]] = pre[0][-1:k[0]-len(pre[0])] = 0

    if np.max(predictions[0]) > 0.5:
        # 如果最高的是LINE_CHART
        if top_k[0] == 0:
            predictions[0][0] = 1
            predictions[0][2] = predictions[0][4] = predictions[0][5] = predictions[0][6] = predictions[0][7] = \
                predictions[0][8] = predictions[0][9] = predictions[0][10] = predictions[0][11] = 0
        # 如果最高的是AREA_CHART
        elif top_k[0] == 1:
            predictions[0][1] = 1
            predictions[0][2] = predictions[0][4] = predictions[0][5] = predictions[0][6] = predictions[0][7] = \
        ...
        # 如果最高的是BAR_CHART
            ...
            predictions[0][0] = predictions[0][1] = predictions[0][3] = predictions[0][4] = predictions[0][5] = \
                predictions[0][6] = predictions[0][7] = predictions[0][8] = predictions[0][9] = predictions[0][10] = \
                predictions[0][11] = 0
        ...
        # 如果最高的是GRID_TABLE
            ...
            predictions[0][6] = 1
            predictions[0][0] = predictions[0][1] = predictions[0][2] = predictions[0][3] = predictions[0][4] = \
                predictions[0][5] = predictions[0][7] = predictions[0][8] = predictions[0][9] = predictions[0][10] = \
                predictions[0][11] = 0
        ...
        # 如果最高的是LINE_TABLE
            ...
            predictions[0][7] = 1
            predictions[0][0] = predictions[0][1] = predictions[0][2] = predictions[0][3] = predictions[0][4] = \
                predictions[0][5] = predictions[0][6] = predictions[0][8] = predictions[0][9] = predictions[0][10] = \
                predictions[0][11] = 0
        ...
        # 如果最高是QR_CODE
            ...
            predictions[0][8] = 1
            predictions[0][0] = predictions[0][1] = predictions[0][2] = predictions[0][3] = predictions[0][4] = \
                predictions[0][5] = predictions[0][6] = predictions[0][7] = predictions[0][9] = predictions[0][10] = \
                predictions[0][11] = 0
        ...
        # 如果最高是INFO_GRAPH
            ...
            predictions[0][9] = 1
            predictions[0][0] = predictions[0][1] = predictions[0][2] = predictions[0][3] = predictions[0][4] = \
                predictions[0][5] = predictions[0][6] = predictions[0][7] = predictions[0][8] = predictions[0][10] = \
                predictions[0][11] = 0
        # 如果最高是TEXT
        elif top_k[0] == 10:
            predictions[0][10] = 1
            predictions[0][0] = predictions[0][1] = predictions[0][2] = predictions[0][3] = predictions[0][4] = \
                predictions[0][5] = predictions[0][6] = predictions[0][7] = predictions[0][8] = predictions[0][9] = \
                predictions[0][11] = 0
...
#    del_unopen(test_set)
    ...
    # 移动图片到相应的类别文件夹
    move_image_to_class(test_set, predictions, dst_dirs='results/classified_zzqr2/')
